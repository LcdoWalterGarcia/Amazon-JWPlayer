...
<body>
	<div class="container">
		...
		<section class="jumbotron text-center">
		    <div class="container">
		      <h1 class="jumbotron-heading">CPanel</h1>
		      <p class="lead text-muted">Amazon JWPlayer</p>
		    </div>
		</section>
	     <br>
	     <br>
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
			<div class="form-group">
				<label class="font-weight-bold">URL Amazon:</label>
				<input type="text" name="link" class="form-control" placeholder="Ex: https://www.amazon.com/clouddrive/share/qtWvuvtBZHDxHcZ6x7p3HCG67OlsKdm3J9MHIr8d3Ha"this.select()" required>
			</div>
				...
				<div class="col-md-11" id="sub">
					<div id="sub-block">
						<div class="row">
						    <div class="col-md-7">
						        <div class="form-group">
						        	<label class="font-weight-bold">Subtitulo</label>
						        	<input type="text" class="form-control" name="sub[0]" placeholder="Ex: tudominio.com/api/apipanel/drop/the.boss.baby.srt (optional)" onclick="this.select()"> 
						        </div>
						    </div>
